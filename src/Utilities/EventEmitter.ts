// Taken from gist - https://gist.github.com/brunosimon/120acda915e6629e3a4d497935b16bdf

// [TODO]: Update this to be used as a component rather than a class that other classes inherit from
// [NOTE]: Three js has an EventDispatcher class, could look into that, also it is possible to write my own observer pattern class
